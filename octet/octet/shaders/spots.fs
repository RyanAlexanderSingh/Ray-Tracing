...
// I should really add anti-aliasing or soft-shadows.  The former is probably low hanging fruit. I can't think of an
// elegant solution to generating unique random numbers on every fragment though to calculate all the offsets.

// broken in windows firefox
// Essentially, given some
// geometry and a ray, find the point at which the
...
// shader optimization, as with OpenCL, defer conditionals/returns as later as pssible and
